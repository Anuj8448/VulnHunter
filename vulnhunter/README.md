...
## Installation
```
git clone https://github.com/Anuj8448/VulnHunter.git /opt/ && cd /opt/vulnhunter
chmod +x /opt/vulnhunter/setup.sh vulnhunter.py && ./setup.sh
python3 -m pip install . && sudo ln -s /opt/vulnhunter/vulnhunter.py /usr/local/bin/vulnhunter
```

## Usage 
 `vulnhunter.py example.com`
